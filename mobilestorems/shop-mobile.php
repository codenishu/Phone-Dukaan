            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Phone Dukaan </li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="banner__box">
                                    <a href="shop-mobile.php" class="banner__link">
                                        <img src="assets/img/banner/sale mobile.jpg"  alt="" class="banner__img">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sort-box m-tb-30">
                        ...
                        <div class="sort-box__left">
                            ...
                            <span style="font-size: 20px;">Phone Dukaan</span>
