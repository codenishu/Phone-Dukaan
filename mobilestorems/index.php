                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="hero hero-slider hero---2">
                        <div class="swiper-wrapper">
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/n.gif);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal title--thin">New Arrivals</div>
                                            <div class="title title--normal title--regular"><h3>Nothing Phone (2)</h3></div>
                                            <div class="title title--description">Sale Offer <span>-20% Off</span> This Week</div>
                                            <a href="shop-mobile.php" class="btn btn--box btn--large btn--blue btn--uppercase btn--weight">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- End Hero Image -->
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2  swiper-slide" style="background-image: url(assets/img/hero/s.gif);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal title--white title--thin">Samsung</div>
                                            <div class="title title--normal title--white title--regular">Galaxy S24/S24+</div>
                                            <div class="title title--description title--white">Sale Offer <span class="title--white">-10% Off</span> This Week</div>
                                            <a href="shop-mobile.php" class="btn btn--box btn--border btn--large btn--uppercase btn--weight">Shop Now</a>
                                        </div>
                                    </div>
                                </div> <!-- End Hero Image -->
                            </div>
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/ap.gif);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal title--white title--thin">Apple</div>
                                            <div class="title title--normal title--white title--regular">iPhone 15</div>
                                            <div class="title title--description title--white">Sale Offer <span class="title--white">-25% Off</span> This Week</div>
                                            <a href="shop-mobile.php" class="btn btn--box btn--large btn--blue btn--uppercase btn--weight">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="banner__box">
                                    <a href="shop-mobile.php" class="banner__link">
                                        <img src="assets/img/banner/n banner.jpg" height="175" width="870" alt="" class="banner__img">
                                    </a>
                                </div>
                            </div>
                        </div>
